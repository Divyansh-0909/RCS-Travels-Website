...
export const VEHICLE_CLASSES = {
    hatchback:   { get "label"() { return dc("Hatchback"); },   category: "Cab Economy", seats: 4, image: HatchBackImage },
    sedan:       { get "label"() { return dc("Sedan"); },       category: "Cab Economy", seats: 4, image: SedanImage },
    suv:         { label: "SUV",         category: "Cab XL",      seats: 6, image: SUVImage },
    suv_premium: { get "label"() { return dc("Premium SUV"); }, category: "Cab XL", seats: 6, image: PremiumSUVImage },
};
...
export const imageOf = (cls) => VEHICLE_CLASSES[cls]?.image ?? null;
