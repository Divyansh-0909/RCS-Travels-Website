                ...
                <div className="flex flex-col justify-center items-start w-[290px] gap-3 sm:gap-4 ">
                    <div className="w-full flex flex-col gap-1 sm:gap-2">
                        <div className="flex flex-col gap-1 sm:gap-2 justify-center items-start w-full">
                            ...
                            <Button prop={{ variant: "input", bg: "var(--background-muted)" }} className="px-3 sm:block hidden pointer-events-none">
                    ...
                    <Button
                        ...
                        prop={{ variant: "input", bg: "var(--background-muted)", innerClassName: "flex justify-between items-center w-full px-4 py-3" }}
                    >
                    ...
                    <div className="flex justify-between w-[290px] items-center">
                        <Button prop={{ variant: "input", width: "140px", bg: "var(--background-muted)" }} className="pointer-events-none">
