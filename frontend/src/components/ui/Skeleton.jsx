// A single shimmer placeholder block; compose several to mirror a real layout.
// `tone="dark"`  → dark surfaces (panels, tracking page)
// `tone="light"` → light surfaces (ride history cards)
