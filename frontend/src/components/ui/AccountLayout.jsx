...
// Shared shell for the account-style settings pages (Manage Account, Settings):
// the RCS header, a left category rail, and a right content column whose title
// is the selected category. `children` are the rows/controls for that category.
const AccountLayout = ({ items, selected, onSelect, children }) => {
