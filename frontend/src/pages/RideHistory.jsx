            ...
            <div className="relative flex flex-col px-8 sm:px-60 gap-6 ">
                {(bookings === null || bookings.length === 0) //add a skeleton state when bookings === null
                    ...
                    <div className="pt-30 sm:pt-40">
                        <Button
                            className={`${expandedBooking ? "block animate-datetime" : "hidden animate-datetime-out"} z-90 py-6 flex flex-col justify-center items-center fixed left-1/2 top-1/2 -translate-x-1/2 mt-10 -translate-y-1/2 hover:opacity-[1]`}
                        ...
                        >
                            ...
                            <div className="flex flex-col justify-center items-center gap-6 px-4 pt-2">
                                ...
                                <div className="flex w-full gap-1 justify-center items-center -my-2">
                                    <div>-----</div>
                                    <h4>RIDE DETAILS</h4>
                                    <div>-----</div>
                                </div>
...
{/* 
                                        <div className={`${expand === booking.id ? "block" : "hidden"} bg-[var(--background)] py-2 -ml-2`}>
                                            <h3>{(booking.driver ? `Your ride was with ${booking.driver.name}.` : "Driver couldn't be assigned.")}</h3>
