    ...
    return (
        <div className="bg-primary-dark text-[var(--text)] py-15 flex flex-col items-center justify-center">
            <div className="text-left flex flex-col w-[82%] md:w-[90%] xl:w-[74%] justify-center gap-8 sm:gap-12 items-start">
                <h1 className="font-bold text-3xl sm:text-5xl text-[var(--text)] bg-[var(--background)] px-4 py-3 sm:pb-4 rounded-xl shadow-[4px_6px_0_rgba(0,0,0,0.25)] sm:shadow-[8px_10px_0_rgba(0,0,0,0.25)] rotate-[-1deg]">Why we started RCS</h1>
