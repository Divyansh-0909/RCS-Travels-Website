...
const PREVIEWS = [
    ...
    ["/dev/vehicle?panel=payment&scheduled=1", "VehicleSelect: scheduled advance payment"],
    ["/dev/vehicle?panel=payment&scheduled=1&payment=verifying", "VehicleSelect: payment verification"],
    ["/dev/vehicle?panel=payment&scheduled=1&payment=cancelled", "VehicleSelect: payment paused"],
    ["/dev/vehicle?panel=payment&scheduled=1&payment=failed", "VehicleSelect: payment failed"],
    ["/dev/vehicle?panel=confirmed&scheduled=1&payment=success", "VehicleSelect: payment success"],
    ...
    ["/dev/tracking?status=pending&driverCancelled=1", "TrackingPage: Ride Now driver cancelled"],
    ...
    ["/dev/tracking?status=completed&scheduled=1&payment=failed", "TrackingPage: remaining payment failed"],
    ["/dev/tracking?status=completed&scheduled=1&payment=cancelled", "TrackingPage: remaining payment paused"],
    ["/dev/tracking?status=completed&scheduled=1&payment=success", "TrackingPage: remaining payment success"],
    ["/dev/tracking?status=payment_pending&scheduled=1", "TrackingPage: advance payment due"],
    ["/dev/tracking?status=confirmed&scheduled=1", "TrackingPage: scheduled, driver not assigned"],
    ["/dev/tracking?status=confirmed&scheduled=1&driverCancelled=1", "TrackingPage: scheduled driver cancelled"],
