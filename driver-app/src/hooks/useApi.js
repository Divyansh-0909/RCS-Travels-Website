...
export function useApi() {
  ...
  return useMemo(() => ({
    ...
    getWallet:     (cursor)             => api.getWallet(cursor, stableGetToken),
    savePayoutAccount: (upiId)          => api.savePayoutAccount(upiId, stableGetToken),
    createDebtPaymentOrder: ()          => api.createDebtPaymentOrder(stableGetToken),
    verifyDebtPayment: (paymentId, response) => api.verifyDebtPayment(paymentId, response, stableGetToken),
