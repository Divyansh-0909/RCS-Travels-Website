  ...
  <AccountDetailScreen title={dc("UPI account")}>
    <AccountSection>
      <View className="flex-row items-start gap-3">
        <View className="w-10 h-10 rounded-xl items-center justify-center bg-surface">
          <BankIcon size={20} weight="regular" color={colors.ink} />
        </View>
        <View className="flex-1">
          <AppText className="font-semibold text-ink">{dc("No UPI account linked")}</AppText>
    ...
    <AccountSection>
      <View className="flex-row items-start gap-3">
        <View className="w-9 h-9 rounded-xl items-center justify-center bg-surface">
          <ShieldCheckIcon size={18} weight="regular" color={colors.ink} />
        </View>
