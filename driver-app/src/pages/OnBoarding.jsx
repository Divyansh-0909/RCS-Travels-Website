...
const SCRIMTOP = "linear-gradient(to bottom, #8fd3f8 10%, #66ccff 15%, transparent 30%)";
    ...
    return (
        <View className="relative flex-1 w-full h-full  overflow-hidden items-center justify-between bg-[var(--background-primary)]">
            <Image
                ...
                resizeMode="cover"
                className="absolute left-0 right-0 -top-10 w-full h-full"
            />
            ...
            <View className="w-full max-w-[500px] h-full py-12 justify-between items-center gap-1">
                <View className="w-full items-center gap-3 mb-4">
                    <AppText className="text-xl bg-[var(--foreground)] my-3 mb-8 py-2 px-3 rounded-full text-[var(--text-foreground)] flex flex-row justify-center items-center font-semibold text-center" style={TITLE_TRACKING}>
                        RCS{" "}
                    ...
                    <View className="flex justify-center items-left gap-2 w-[85%] h-fit">
                        <AppText className="text-4xl text-[var(--text-foreground)] font-semibold text-left" style={TITLE_TRACKING}>
                            {heading}
                        </AppText>
                        <AppText className="text-lg text-left text-[var(--text-foreground)]">
